...
## ✅ Что было сделано (Work Done)

Ниже собраны ключевые задачи и решения, которые я реализовал в проекте.
...
- Единый нормализованный датасет для DataLens.  
- Приведение данных к единым форматам дат, сумм, валют.  
